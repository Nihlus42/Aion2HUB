...
const STAT_INFO: Record<StatKey, StatInfo> = {
  ...
  accuracy: { label: "Précision", group: "Offensif" },
  criticalHit: { label: "Critique", group: "Offensif" },
  criticalDamage: { label: "Dégâts critiques", group: "Offensif" },
  defense: { label: "Défense", group: "Defensif" },
  evasion: { label: "Esquive", group: "Defensif" },
  block: { label: "Blocage", group: "Defensif" },
  parry: { label: "Parade", group: "Defensif" },
  criticalResist: { label: "Résistance critique", group: "Defensif" },
  pveDamageBoost: { label: "Bonus dégâts PvE", group: "PvE / PvP", isPercent: true },
  pveDamageTolerance: { label: "Résistance dégâts PvE", group: "PvE / PvP", isPercent: true },
  pvpDamageBoost: { label: "Bonus dégâts PvP", group: "PvE / PvP", isPercent: true },
  pvpDamageTolerance: { label: "Résistance dégâts PvP", group: "PvE / PvP", isPercent: true },
  attackSpeed: { label: "Vitesse d’attaque", group: "Offensif", isPercent: true },
  skillSpeed: { label: "Vitesse de compétence", group: "Offensif", isPercent: true },
};
