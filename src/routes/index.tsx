...
function HomePage() {
  const target = new Date(Date.UTC(2026, 8, 17, 13, 0, 0));
        ...
        <div className="container mx-auto px-4 pt-24 pb-36 relative">
          <div className="max-w-2xl animate-fade-up">
            ...
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed max-w-xl">
              Actualités AION 2 en français, classes, compétences, builds et timers vraiment utiles
              pour suivre le MMORPG sans perdre ton temps.
            </p>
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                to="/updates"
                className="px-6 py-3 rounded-md bg-gradient-arcane text-primary-foreground font-semibold shadow-glow hover:shadow-gold-glow hover:scale-[1.03] transition-all inline-flex items-center gap-2"
              >
                Voir les actualités <ArrowRight className="w-4 h-4" />
              </Link>
              <Link
                to="/builds"
                className="px-6 py-3 rounded-md border border-gold/40 text-gold font-semibold hover:bg-gold/10 hover:border-gold transition-all"
              >
      ...
      <section className="container mx-auto px-4 -mt-16 relative z-10">
        <div className="rune-border rune-border-hover rounded-2xl p-8 shadow-elevated relative overflow-hidden">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 relative">
            <div>
              <Eyebrow>
                <Calendar className="w-3.5 h-3.5" /> DERNIÈRE GRANDE ACTU
              </Eyebrow>
              <h2 className="font-display text-2xl md:text-3xl">
                Stress test global : lancement le 17 septembre
              </h2>
              <p className="text-sm text-muted-foreground mt-1">
                NCSoft lance un Launch Scale Test public le 17 septembre à 15 h CEST. L’Early
                Access, lui, reste calé au 30 septembre 2026.
              </p>
            </div>
            <div className="grid grid-cols-4 gap-3 md:gap-4">
              {[
                ...
                <div
                  key={u.l}
                  className="text-center bg-background/70 border border-gold/20 rounded-lg px-3 py-3 md:px-5 md:py-4 min-w-[64px]"
                >
                  <div className="font-display text-2xl md:text-4xl text-gradient-gold tabular-nums">
                    {String(u.v).padStart(2, "0")}
                  </div>
                  <div className="text-[10px] md:text-xs tracking-[0.25em] text-muted-foreground mt-1">
                    {u.l.toUpperCase()}
                  </div>
                </div>
              ))}
      ...
      <section className="container mx-auto px-4 py-24">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            {
              icon: Sword,
              title: "8 classes iconiques",
              desc: "Détails des classes avec rôle, difficulté et compétences signatures.",
              to: "/classes" as const,
            },
            {
              icon: Shield,
              title: "Planificateur Daevanion",
              desc: "Construis ton plateau, gère les points et optimise tes nœuds.",
              to: "/daevanion-planner" as const,
            },
            {
              icon: Calendar,
              title: "Suivi des updates",
              desc: "Reste calé sur les annonces officielles et les infos vérifiées.",
              to: "/updates" as const,
            },
          ].map((f, i) => (
            <Link
        ...
        <div className="rune-border rounded-2xl p-10 md:p-16 text-center bg-gradient-to-br from-card to-background relative overflow-hidden">
          <div className="relative">
            ...
            <h2 className="font-display text-3xl md:text-5xl mb-4">
              Explore les skills des classes
            </h2>
            <p className="text-muted-foreground max-w-xl mx-auto mb-8 leading-relaxed">
              Theorycraft plus vite avec les classes, compétences, actualités et un planificateur
              pratique.
            </p>
            <Link
              to="/classes"
      ...
      <section className="container mx-auto px-4 pb-24">
        <div className="mx-auto max-w-4xl rune-border rounded-2xl p-8 md:p-10">
          <h2 className="font-display text-3xl md:text-4xl mb-4">
            Pourquoi utiliser Aion2FrenchHub ?
          </h2>
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              Aion2FrenchHub est un hub fan AION 2 en français pensé pour aller à l’essentiel :
              suivre les news importantes, comparer les classes, explorer les compétences et
              préparer ses builds sans devoir fouiller dix sources dispersées.
            </p>
            <p>
              Le site met en avant les informations vérifiées, les pages de classes, les outils de
              theorycraft et les rappels d’événements utiles pour les joueurs qui veulent un point
              d’entrée clair sur AION 2 FR.
            </p>
          </div>
        </div>
      </section>
